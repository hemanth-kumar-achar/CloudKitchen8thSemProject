        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/cloud-kitchen.png" width="65" height="35" alt=""> </a>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rs.<?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="number" name="quantity"  style="margin-left:20px;" min="1" max="10" value="1" size="2" />
